...
<div class="grid">
  <form action="" method="POST" class="form login" id="login-box">
    <div class="form__field">
      ...
      <input id="login__confirmpassword" type="password" name="confirmpassword" class="form__input" placeholder="Mot de passe" style="height:50px">
    </div>
    ...
    <div class="form__field">
      <label for="login__password"  style="height:50px">
        ...
        <span class="hidden">Confirmation Mot de passe</span></label>
      <input id="login__password" type="password" name="password" class="form__input" placeholder="Confirmation Mot de passe"  style="height:50px">
    </div>
